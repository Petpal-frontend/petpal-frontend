...
## 14. 프로젝트 진행 소감
### 김소리
이번 프로젝트를 통해 일단 다들 열심히 하시는 팀원 분들을 만나 프로젝트가 잘 진행되었고 많은걸 배워가게 되어 감사합니다.  서로 진행 상황을 계속 공유하고 막히는 부분은 다같이 보며 해결하기도 하고, 주기적인 회의를 진행하여 시간 대비 목표 달성이 수월 했던 것 같습니다. 
아쉬운 점이라면 UI나 상태관리 등에 좀 더 다양한 기술이나 라이브러리를 적용하지 못해본 것과 구현하는 데만 집중하다 보니 코드나 성능을 개선 하지는 못한 것 같습니다. 이 부족한 부분에 대해서는 팀원들과 리팩토링 과정에서 채워나가보도록 하겠습니다!

### 류경민
코딩을 처음 시작한 멋사에서 점점 어려워지는 공부에 번아웃이 찾아왔을 때, 좋은 프로젝트 팀을 만나 제 자신의 성장을 체감할 수 있는 소중한 계기가 되었습니다. 
지금까지 혼자서 완성도 있는 결과물을 내기 어려웠는데, 이번 프로젝트를 통해 끝까지 해낼 수 있는 경험을 만들어준 팀원 분들께 감사합니다. 깃헙을 활용한 협업, 리액트, 상태 관리, 소통 방법 등 팀원 분들이 함께 고민을 나누어 준 덕분에 많은 것을 배울 수 있었습니다.
진행 과정에서 맡은 일에 시간 분배를 잘 나누지 못한 점과 에러와 해결 과정을 상세하게 기록하지 못한 점이 아쉬움으로 남습니다. 이 부분은 앞으로의 발전 과제로 삼고, 리팩토링 과정에서 지속적으로 개선해 나가고자 합니다.
우리는 리팩토링 때 다시 만나요ㅎ

### 최지완
안녕하세요 최지완입니다.
우리가 처음 프로젝트 아이디어를 냈을 때를 생각하면 재미있고, 빨리 개발에 들어가고싶고 그랬던거같은데, 막상 개발에 들어가서 막히는게 생기면 재미는 뚝 떨어지고 시간만 흘러가는 그런때가 많았습니다.
그럴 때마다 팀원들과 진행상황을 공유해서 문제를 해결했었는데, 이런 경험들이 나중에 개발이 거듭 될수록 맞닥들이는 문제들을 해결 하는 힘이 되었던것같아요. 좋은 팀원들을 만나는데 올 해 운 다 썼습니다. 너무 고생했고 감사합니다. 바주카포 최지완이였습니다. 

### 최현아
리액트로 하는 팀프로젝트는 처음이라 잘 할 수 있을지 걱정도 됐지만, 좋은 팀원분들을 만나서 잘 해낼 수 있었습니다. 프로젝트를 진행하면서 사용해본적 없는 라이브러리나 협업하는 방법 등 많은 것을 배울 수 있었고, 강의로도 많이 배웠지만 프로젝트 진행중에 더 많은 걸 얻어가는 것 같습니다. 그리고 모르는 걸 물어볼때마다 친절하게 알려주신 팀원분들 감사하고, 4개월 동안 다들 열심히 해왔는데 너무 고생 많으셨습니다!
